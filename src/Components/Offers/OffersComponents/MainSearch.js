...
import { choosePowerMin, choosePowerMax } from '../../../Actions/choosePowerActions';
import { chooseYearMin, chooseYearMax } from '../../../Actions/chooseYearActions';
import { choosePriceMin, choosePriceMax } from '../../../Actions/choosePriceActions';
...
class MainSearch extends Component {
   ...
   */
  minPowerShow() {
    this.setState((prevState) => ({ minPowerShow: !prevState.minPowerShow }));
    this.setState({ makerShow: false });
    this.setState({ modelShow: false });
    this.setState({ maxPowerShow: false });
    this.setState({ minYearsShow: false });
   ...
   */
  maxPowerShow() {
    this.setState((prevState) => ({ maxPowerShow: !prevState.maxPowerShow }));
    this.setState({ makerShow: false });
    this.setState({ modelShow: false });
    this.setState({ minPowerShow: false });
    this.setState({ minYearsShow: false });
   ...
   */
  minYearsShow() {
    this.setState((prevState) => ({ minYearsShow: !prevState.minYearsShow }));
    this.setState({ makerShow: false });
    this.setState({ modelShow: false });
    this.setState({ minPowerShow: false });
    this.setState({ maxPowerShow: false });
  ...
  */
  maxYearsShow() {
    this.setState((prevState) => ({ maxYearsShow: !prevState.maxYearsShow }));
    this.setState({ makerShow: false });
    this.setState({ modelShow: false });
    this.setState({ minPowerShow: false });
    this.setState({ minYearsShow: false });
   ...
   */
  minPricesShow() {
    this.setState((prevState) => ({ minPricesShow: !prevState.minPricesShow }));
    this.setState({ makerShow: false });
    this.setState({ modelShow: false });
    this.setState({ minPowerShow: false });
    this.setState({ minYearsShow: false });
   ...
   */
  maxPricesShow() {
    this.setState((prevState) => ({ maxPricesShow: !prevState.maxPricesShow }));
    this.setState({ makerShow: false });
    this.setState({ modelShow: false });
    this.setState({ minPowerShow: false });
    this.setState({ minYearsShow: false });
            ...
            <AttrContainer>
              ...
              <AttrChoose>
                <AnyAttr onClick={this.minPowerShow}>
                  <AnyAttrText>
                    { (this.props.chosenPower.minPower === null) ? 'Min Power' : this.props.chosenPower.minPower}
                    {' '}
                    KM
                  </AnyAttrText>
                  <ArrowDropDownIcon />
                ...
                <DropDownContentMinPower minPowerShow={this.state.minPowerShow} onClick={this.minPowerShow}>
                  {(POWERS.powerMin === undefined) ? null : (POWERS.powerMin.map((value) => (
                    <SubAttr key={value} onClick={() => this.minPowerChange({ value })}>
                      {value}
&nbsp;KM
                    </SubAttr>
                  ))) }
              ...
              <AttrChoose>
                <AnyAttr onClick={this.maxPowerShow}>
                  <AnyAttrText>
                    { (this.props.chosenPower.maxPower === null) ? 'Max Power' : this.props.chosenPower.maxPower}
                    {' '}
                    KM
                  </AnyAttrText>
                  <ArrowDropDownIcon />
                ...
                <DropDownContentMaxPower maxPowerShow={this.state.maxPowerShow} onClick={this.maxPowerShow}>
                  {(POWERS.powerMax === undefined) ? null : (POWERS.powerMax.map((value) => (
                    <SubAttr key={value} onClick={() => this.maxPowerChange({ value })}>
                      {value}
&nbsp;KM
                    </SubAttr>
                  ))) }
            ...
            <AttrContainer>
              ...
              <AttrChoose>
                <AnyAttr onClick={this.minYearsShow}>
                  <AnyAttrText>
                    From
                    { (this.props.chosenYear.minYear === null) ? null : this.props.chosenYear.minYear}
                  </AnyAttrText>
                  <ArrowDropDownIcon />
                </AnyAttr>
              ...
              <AttrChoose>
                <AnyAttr onClick={this.maxYearsShow}>
                  <AnyAttrText>
                    To
                    { (this.props.chosenYear.maxYear === null) ? null : this.props.chosenYear.maxYear}
                  </AnyAttrText>
                  <ArrowDropDownIcon />
                </AnyAttr>
            ...
            <AttrContainer>
              ...
              <AttrChoose>
                <AnyAttr onClick={this.minPricesShow}>
                  <AnyAttrText>
                    From
                    { (this.props.chosenPrice.minPrice === null) ? null : this.props.chosenPrice.minPrice}
                    {' '}
                    PLN
                  </AnyAttrText>
                  <ArrowDropDownIcon />
              ...
              <AttrChoose>
                <AnyAttr onClick={this.maxPricesShow}>
                  <AnyAttrText>
                    To
                    { (this.props.chosenPrice.maxPrice === null) ? null : this.props.chosenPrice.maxPrice}
                    {' '}
                    PLN
                  </AnyAttrText>
                  <ArrowDropDownIcon />
