  ...
  render() {
    return (
      <SubNaviContainer>
        ...
        {(this.props.chosenMaker.maker === undefined || this.props.chosenMaker.maker === 'Any Maker') ? '' : (
          <StyledLink to="/Offers" onClick={this.resetWithoutMaker}>
            <RightSymbol>&nbsp;&gt;&nbsp;</RightSymbol>
            {this.props.chosenMaker.maker}
          </StyledLink>
        )}
        {(this.props.chosenModel.chosenModel === undefined || this.props.chosenModel.chosenModel === 'Any Model') ? '' : (
