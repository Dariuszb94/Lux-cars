...
class VehicleInfoFeatures extends Component {
  ...
  vehicleSummaryListShow() {
    this.setState((prevState) => ({ vehicleSummaryListShow: !prevState.vehicleSummaryListShow }));
  }

  vehiclePerformanceListShow() {
    this.setState((prevState) => ({ vehiclePerformanceListShow: !prevState.vehiclePerformanceListShow }));
  }

  vehicleDimensionsListShow() {
    this.setState((prevState) => ({ vehicleDimensionsListShow: !prevState.vehicleDimensionsListShow }));
  }
          ...
          >
            <VehicleSummaryListDropDown vehicleSummaryListShow={this.state.vehicleSummaryListShow}>
              <VehicleSummaryListElement>
                <VehicleSummaryListElementLeft>Body style</VehicleSummaryListElementLeft>
                <VehicleSummaryListElementRight>{CARS[window.location.href.slice(21).replace(/\D/g, '')].body}</VehicleSummaryListElementRight>
              </VehicleSummaryListElement>
              <VehicleSummaryListElement>
                <VehicleSummaryListElementLeft>Engine size</VehicleSummaryListElementLeft>
              ...
              <VehicleSummaryListElement>
                <VehicleSummaryListElementLeft>Number of doors</VehicleSummaryListElementLeft>
                <VehicleSummaryListElementRight>{CARS[window.location.href.slice(21).replace(/\D/g, '')].doors}</VehicleSummaryListElementRight>
              </VehicleSummaryListElement>
              <VehicleSummaryListElement>
                <VehicleSummaryListElementLeft>Number of seats</VehicleSummaryListElementLeft>
                <VehicleSummaryListElementRight>{CARS[window.location.href.slice(21).replace(/\D/g, '')].seats}</VehicleSummaryListElementRight>
              </VehicleSummaryListElement>
              <VehicleSummaryListElement>
                <VehicleSummaryListElementLeft>Transmission</VehicleSummaryListElementLeft>
                <VehicleSummaryListElementRight>{CARS[window.location.href.slice(21).replace(/\D/g, '')].gearBox}</VehicleSummaryListElementRight>
              </VehicleSummaryListElement>
...
&nbsp;Vehicle Performance
          ...
          >
            <VehiclePerformanceListDropDown vehiclePerformanceListShow={this.state.vehiclePerformanceListShow}>
              <VehicleSummaryListElement>
                <VehicleSummaryListElementLeft>0-100 km/h</VehicleSummaryListElementLeft>
                <VehicleSummaryListElementRight>
                  {CARS[window.location.href.slice(21).replace(/\D/g, '')].acceleration}
                  {' '}
                  s
                </VehicleSummaryListElementRight>
              </VehicleSummaryListElement>
              <VehicleSummaryListElement>
                <VehicleSummaryListElementLeft>Top speed</VehicleSummaryListElementLeft>
                <VehicleSummaryListElementRight>
                  {CARS[window.location.href.slice(21).replace(/\D/g, '')].topSpeed}
                  {' '}
                  km/h
                </VehicleSummaryListElementRight>
              </VehicleSummaryListElement>
              <VehicleSummaryListElement>
                <VehicleSummaryListElementLeft>Cylinders</VehicleSummaryListElementLeft>
                <VehicleSummaryListElementRight>{CARS[window.location.href.slice(21).replace(/\D/g, '')].cylinders}</VehicleSummaryListElementRight>
              </VehicleSummaryListElement>
              <VehicleSummaryListElement>
                <VehicleSummaryListElementLeft>Engine power</VehicleSummaryListElementLeft>
                <VehicleSummaryListElementRight>
                  {CARS[window.location.href.slice(21).replace(/\D/g, '')].power}
                  {' '}
                  KM
                </VehicleSummaryListElementRight>
              </VehicleSummaryListElement>
              <VehicleSummaryListElement>
                <VehicleSummaryListElementLeft>Engine torque</VehicleSummaryListElementLeft>
                <VehicleSummaryListElementRight>
                  {CARS[window.location.href.slice(21).replace(/\D/g, '')].torque}
                  {' '}
                  Nm
                </VehicleSummaryListElementRight>
              </VehicleSummaryListElement>
...
&nbsp;Dimensions
          ...
          >
            <VehicleDimensionsListDropDown vehicleDimensionsListShow={this.state.vehicleDimensionsListShow}>
              <VehicleSummaryListElement>
                <VehicleSummaryListElementLeft>Height</VehicleSummaryListElementLeft>
                <VehicleSummaryListElementRight>
                  {CARS[window.location.href.slice(21).replace(/\D/g, '')].height}
                  {' '}
                  mm
                </VehicleSummaryListElementRight>
              </VehicleSummaryListElement>
              <VehicleSummaryListElement>
                <VehicleSummaryListElementLeft>Length</VehicleSummaryListElementLeft>
                <VehicleSummaryListElementRight>
                  {CARS[window.location.href.slice(21).replace(/\D/g, '')].length}
                  {' '}
                  mm
                </VehicleSummaryListElementRight>
              </VehicleSummaryListElement>
              <VehicleSummaryListElement>
                <VehicleSummaryListElementLeft>Wheelbase</VehicleSummaryListElementLeft>
                <VehicleSummaryListElementRight>
                  {CARS[window.location.href.slice(21).replace(/\D/g, '')].wheelbase}
                  {' '}
                  mm
                </VehicleSummaryListElementRight>
              </VehicleSummaryListElement>
              <VehicleSummaryListElement>
                <VehicleSummaryListElementLeft>Width</VehicleSummaryListElementLeft>
                <VehicleSummaryListElementRight>
                  {CARS[window.location.href.slice(21).replace(/\D/g, '')].width}
                  {' '}
                  mm
                </VehicleSummaryListElementRight>
              </VehicleSummaryListElement>
